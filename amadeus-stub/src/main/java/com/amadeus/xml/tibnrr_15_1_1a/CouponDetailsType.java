 ...
 *       &lt;sequence>
 *         &lt;element name="productId" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}ReferenceInfoType"/>
 *         &lt;element name="flightConnectionType" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}TravelProductInformationType" minOccurs="0"/>
 *         &lt;element name="couponTaxDetailsGroup" maxOccurs="99" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="taxTriggerInfo" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}DutyTaxFeeDetailsType"/>
 *                   &lt;element name="taxDetails" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}TaxType" minOccurs="0"/>
 *                   &lt;element name="monetaryInfo" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}MonetaryInformationType_193359S" minOccurs="0"/>
 *                   &lt;element name="locationInfo" type="{http://xml.amadeus.com/TIBNRR_15_1_1A}PlaceLocationIdentificationType" minOccurs="0"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
public class CouponDetailsType {
    ...
    protected List<CouponDetailsType.CouponTaxDetailsGroup> couponTaxDetailsGroup;
     ...
     * {@link CouponDetailsType.CouponTaxDetailsGroup }
     * 
     * 
     */
    public List<CouponDetailsType.CouponTaxDetailsGroup> getCouponTaxDetailsGroup() {
        if (couponTaxDetailsGroup == null) {
            couponTaxDetailsGroup = new ArrayList<CouponDetailsType.CouponTaxDetailsGroup>();
        }
    ...
    public static class CouponTaxDetailsGroup {
        ...
        protected MonetaryInformationType193359S monetaryInfo;
         ...
         * @return
         *     possible object is
         *     {@link MonetaryInformationType193359S }
         *     
         */
        public MonetaryInformationType193359S getMonetaryInfo() {
            return monetaryInfo;
        }
         ...
         *     
         */
        public void setMonetaryInfo(MonetaryInformationType193359S value) {
