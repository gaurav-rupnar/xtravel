...
public class FromLoc implements Serializable
{
    ...
    private final static long serialVersionUID = 797021481844456981L;
     ...
     * @param trmnl
     */
    public FromLoc(String dtTime, String loc, String arptCd, String trmnl) {
        super();
        this.dtTime = dtTime;
        this.loc = loc;
        this.arptCd = arptCd;
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof FromLoc) == false) {
            return false;
        }
        FromLoc rhs = ((FromLoc) other);
